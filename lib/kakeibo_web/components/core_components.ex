defmodule KakeiboWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(KakeiboWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(KakeiboWeb.Gettext, "errors", msg, opts)
    # end
